...
var CodeMirrorLite = function CodeMirrorLite(_a) {
  ...
  var valueRef = React.useRef(valueProp);
  valueRef.current = valueProp;
  var onChangeRef = React.useRef(onChangeProp);
  onChangeRef.current = onChangeProp;
  var onViewChangeRef = React.useRef(onViewChangeProp);
  onViewChangeRef.current = onViewChangeProp;
  var extensionsRef = React.useRef(extensions);
  var editorParentElRef = React.useRef(null);
  var editorRef = React.useRef(null);
  var changeHandlerRef = React.useRef(null);
  React.useEffect(function () {
    ...
    if (editorParentElRef.current !== null) {
      ...
      var state$1 = state.EditorState.create({
        ...
        extensions: [view.EditorView.theme({
          '&': {
            alignSelf: 'stretch',
            flex: '1 0 auto'
          }
        }), extensionsRef.current, state.EditorState.transactionFilter.of(function (tr) {
          var _a;
...
exports.CodeMirrorLite = CodeMirrorLite;
